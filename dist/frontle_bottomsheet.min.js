...
var BottomSheet = /*#__PURE__*/function () {
  function BottomSheet(parents, html) {
    ...
    _defineProperty(this, "elemSelector", '.frontleBottomSheet');
    // options
    ...
    sheetElement.querySelector('.frontleBottomSheetContents').style = "max-height: ".concat(this.height, "vh;\n        height: ").concat(this.height, "vh;\n        z-index: ").concat(this.zIndex + 2, ";\n        bottom: -").concat(this.height, "vh;");
