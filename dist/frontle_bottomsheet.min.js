...
var BottomSheet = /*#__PURE__*/function () {
  function BottomSheet(parents, html) {
    ...
    _defineProperty(this, "sheetClass", '');
    _defineProperty(this, "contentsClass", '');
    _defineProperty(this, "backgroundClass", '');
  ...
  return _createClass(BottomSheet, [{
    ...
    value: function () {
      var _open = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var _this = this;
        var id, zIndex, sheetId, sheetCSSElement, html, sheetElement;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              // create id
              id = String(BottomSheet.makeID(32)); // get z-index
              zIndex = (0,_util_zIndexManager_js__WEBPACK_IMPORTED_MODULE_21__.findHighestZIndex)(this.parents); // set sheet id
              sheetId = 'sheet_' + id; // set status
              this.status[sheetId] = {};
              ...
              if (document.getElementById('frontleBottomSheetCSS') === null) {
                sheetCSSElement = document.createElement('style');
              ...
              // run lifecycle
              _context2.next = 16;
              return this.beforeOpen(sheetId);
            case 16:
              // start sheet animation
              setTimeout(function () {
                // background opacity
                var sheetBackground = sheetElement.querySelector('.frontleBottomSheetBackground');
                if (sheetBackground !== null) {
                  sheetBackground.style.opacity = '0.4';
                }

                // contents pos move up
                var sheetContents = sheetElement.querySelector('.frontleBottomSheetContents');
                ...
                return _regeneratorRuntime().wrap(function _callee$(_context) {
                  while (1) switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      sheetBar = sheetElement.querySelector('.frontleBottomSheetBar');
                      if (sheetBar !== null) {
                        _this.status[sheetId].mouseDownEvent = function (e) {
                          e.preventDefault();
                          _this.eventMouseDown(sheetId);
                        };
                        sheetBar.addEventListener('mousedown', _this.status[sheetId].mouseDownEvent, false);
                        _this.status[sheetId].touchStartEvent = function () {
                          _this.eventMouseDown(sheetId);
                        };
                        sheetBar.addEventListener('touchstart', _this.status[sheetId].touchStartEvent, false);
                      }
                      sheetContents = sheetElement.querySelector('.frontleBottomSheetContents'); // set mouse up event
                      _this.status[sheetId].mouseUpEvent = function (e) {
                        e.preventDefault();
                        _this.eventMouseUp(e, sheetId, sheetContents);
                      };
                      document.addEventListener('mouseup', _this.status[sheetId].mouseUpEvent, false);
                      _this.status[sheetId].touchEndEvent = function (e) {
                        _this.eventMouseUp(e.changedTouches[0], sheetId, sheetContents);
                      };
                      document.addEventListener('touchend', _this.status[sheetId].touchEndEvent, false);

                      // set mouse move event
                      _this.status[sheetId].mouseMoveEvent = function (e) {
                        e.preventDefault();
                        _this.eventMouseMove(e, sheetId, sheetContents);
                      };
                      document.addEventListener('mousemove', _this.status[sheetId].mouseMoveEvent, false);
                      _this.status[sheetId].touchMoveEvent = function (e) {
                        _this.eventMouseMove(e.changedTouches[0], sheetId, sheetContents);
                      };
                      document.addEventListener('touchmove', _this.status[sheetId].touchMoveEvent, false);
                      ...
                      // run lifecycle
                      _context.next = 15;
                      return _this.afterOpen(sheetId);
                    case 15:
                    case "end":
              ...
              return _context2.abrupt("return", sheetId);
            case 19:
            case "end":
